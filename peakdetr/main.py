...
def get_args_parser():
    ...
    parser.add_argument('--coco_path', type=str, default='/home/zzy/data/peak-all')
    parser.add_argument('--coco_panoptic_path', type=str)
    parser.add_argument('--remove_difficult', action='store_true')

    parser.add_argument('--output_dir', default='/home/zzy/data/11-10',
                        help='path where to save, empty for no saving')
    parser.add_argument('--device', default='cuda',
                        help='device to use for training / testing')
    parser.add_argument('--seed', default=42, type=int)

    parser.add_argument('--resume', default='/home/zzy/data/detr-r50-e632da11.pth',
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser('PeakFormer training and evaluation script', parents=[get_args_parser()])
