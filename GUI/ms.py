...
class Ui_PeakFormer(object):
    def setupUi(self, PeakFormer):
        if not PeakFormer.objectName():
            PeakFormer.setObjectName(u"PeakFormer")
        PeakFormer.resize(837, 603)
        self.centralwidget = QWidget(PeakFormer)
        ...
        self.showEIC.setObjectName(u"showEIC")
        ...
        self.eicPredict.setObjectName(u"eicPredict")
        ...
        PeakFormer.setCentralWidget(self.centralwidget)
        self.menubar = QMenuBar(PeakFormer)
        self.menubar.setObjectName(u"menubar")
        self.menubar.setGeometry(QRect(0, 0, 837, 21))
        PeakFormer.setMenuBar(self.menubar)
        self.statusbar = QStatusBar(PeakFormer)
        self.statusbar.setObjectName(u"statusbar")
        PeakFormer.setStatusBar(self.statusbar)

        self.retranslateUi(PeakFormer)

        QMetaObject.connectSlotsByName(PeakFormer)
    # setupUi

    def retranslateUi(self, PeakFormer):
        PeakFormer.setWindowTitle(QCoreApplication.translate("PeakFormer", u"PeakFormer", None))
        self.eicPostprogress.setText(QCoreApplication.translate("PeakFormer", u"postprogress", None))
        self.featureImport.setText(QCoreApplication.translate("PeakFormer", u"csv", None))
        self.label_4.setText(QCoreApplication.translate("PeakFormer", u"PeakFormer predict", None))
        self.label_2.setText(QCoreApplication.translate("PeakFormer", u"Feature table import", None))
        self.resultsExport.setText(QCoreApplication.translate("PeakFormer", u"csv", None))
        self.pushButton.setText(QCoreApplication.translate("PeakFormer", u"output", None))
        self.showEIC.setText("")
        self.label_8.setText(QCoreApplication.translate("PeakFormer", u"PeakFormer", None))
        self.label_10.setText(QCoreApplication.translate("PeakFormer", u"Model load", None))
        self.label_9.setText(QCoreApplication.translate("PeakFormer", u"Set EIC output dir", None))
        self.label_5.setText(QCoreApplication.translate("PeakFormer", u"Peak quantify", None))
        self.mzmlImport.setText(QCoreApplication.translate("PeakFormer", u"mzML", None))
        self.checkBox.setText(QCoreApplication.translate("PeakFormer", u"plot", None))
        self.label_3.setText(QCoreApplication.translate("PeakFormer", u"EIC build", None))
        self.label_7.setText(QCoreApplication.translate("PeakFormer", u"Results export", None))
        self.eicQuantify.setText(QCoreApplication.translate("PeakFormer", u"quantify", None))
        self.eicBuild.setText(QCoreApplication.translate("PeakFormer", u"EIC", None))
        self.label_6.setText(QCoreApplication.translate("PeakFormer", u"Results postprogress", None))
        self.label.setText(QCoreApplication.translate("PeakFormer", u"mzML files import", None))
        self.eicPredict.setText(QCoreApplication.translate("PeakFormer", u"predict", None))
        self.modelLoad.setText(QCoreApplication.translate("PeakFormer", u"model", None))
    # retranslateUi
